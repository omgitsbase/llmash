...
// FIPS 180-4. Written out rather than called through Windows' crypto API:
// an import of bcrypt.dll beside a directory walk is a shape malware
// scanners score against, and this needs no key material anyway.
const uint32_t K[64] = {
